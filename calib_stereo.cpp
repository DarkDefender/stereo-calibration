...
void load_image_points(int board_width, int board_height, 
		//int num_imgs, 
		float square_size,
	...
	cv::VideoCapture capL(leftimg_filename);
	cv::VideoCapture capR(rightimg_filename);
	int num_imgs = capL.get(CV_CAP_PROP_FRAME_COUNT);
...
int main(int argc, char const *argv[])
{
	...
	load_image_points(fsl["board_width"], fsl["board_height"], 
			//num_imgs, 
			fsl["square_size"],
			//leftimg_dir, rightimg_dir, 
			leftimg_filename, rightimg_filename);
